...
public class MongoDbContaCorrenteDbSchemaMigrator : IContaCorrenteDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbContaCorrenteDbSchemaMigrator(IServiceProvider serviceProvider)
    {
